  ...
  if($params['card_switch'] == 0) {
    ...
    foreach($deck as $k => $v) {
      ...
      $add_center_buff = function ($skill) use (&$v) {
        $src_attr = [1=>'smile', 2=>'smile', 3=>'smile', 33=>'smile', 35=>'smile', 4=>'cute', 5=>'cute', 6=>'cute', 31=>'cute', 36=>'cute', 7=>'cool', 8=>'cool', 9=>'cool', 32=>'cool', 34=>'cool'];
        $target_attr = [1=>'smile', 2=>'smile', 3=>'smile', 31=>'smile', 32=>'smile', 4=>'cute', 5=>'cute', 6=>'cute', 33=>'cute', 34=>'cute', 7=>'cool', 8=>'cool', 9=>'cool', 35=>'cool', 36=>'cool'];
        $rate = [1=>0.03, 4=>0.03, 7=>0.03, 2=>0.06, 5=>0.06, 8=>0.06, 3=>0.07, 6=>0.07, 9=>0.07, 31=>0.12, 32=>0.12, 33=>0.12, 34=>0.12, 35=>0.12, 36=>0.12];
        $v['total_'.$target_attr[$skill]] += round($v['subtotal_'.$src_attr[$skill]] * $rate[$skill]);
      };
...
function live_reward($post) {
  ...
  $clear_card = [1=>1,2=>1,3=>1,4=>2,5=>2];
  $rank_card = [1=>[1,1,1,1],2=>[1,1,1,1],
          3=>[2,2,2,2],4=>[3,3,3,3],5=>[3,3,3,3]];
  $combo_card = [1=>[1,1,1,1],2=>[2,2,2,1],
          3=>[3,3,2,2],4=>[3,3,3,3],5=>[3,3,3,3]];
  if (isset($post['festival'])) {
